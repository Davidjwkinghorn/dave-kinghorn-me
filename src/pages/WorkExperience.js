    ...
    this.workExperienceDBQuery = [
      {
        ...
        text: "Worked on a team of three other Software Engineering students for our senior \
        project to design and develop a web app to allow employees of Lockheed Martin to \
        create custom drag and drop social events and send invites to other employees. Tools: \
        AngularJS, GrapesJS, GraphQL, Apollo.",
      },{
        date: "2019",
        ...
        text: "Worked on a team with six other software developers to produce two quantum \
        computer simulators. Responsible for design, development, and testing. Noisy Quantum \
        Computer Simulator: Produced a simulator to replicate noise and real-world errors in \
        a quantum computer to support a published paper. Photonics Simulator: Developed a \
        multi part simulator to test experiments for a Quantum Photonic Processor. Tools: \
        Python, Qiskit, Pyquil, Cirq",
      },{
        date: "2018",
        title: "SciAps. Woburn, MA",
        subtitle: "Co-op",
        text: "Worked on a six-member agile software team to create an Android version of a \
        Python desktop application for hardware QA. Responsible for design, development \
        (Full Stack), and testing. Side project: Taught Java/Android development to team \
        physicist. Tools: Android, Java, RxAndroid, Android Studio, Gradle",
      },{
        date: "2018",
        ...
        text: "Developed solutions for the collection of usage metrics from associates to \
        automate feedback. Virtual tour: Created virtual tour POC for investment centers (with \
        VR support). Sprout: Planed through inception phase of a new app to encourage younger \
        generations to invest. Tools: Python, DTW distance algorithm, UI Mockups.",
      },{
        date: "2015",
        ...
        text: "Techworks: Assisting manager with Fidelity Premium Support Services; \
        troubleshooting; imaging and deploying machines; deploying and retrieving equipment; \
        filing hardware requests; taking inventory. FCAT: Fidelity Center for Applied Technology \
        (FCAT) Executive Briefing Center. Assisted various group members; monitored/recorded \
        high-level meetings; recorded and pushed slides on Fidelity TV; Built nonstandard \
        Desktops; maintained and updated large interactive displays.",
      },{
        date: "2014",
